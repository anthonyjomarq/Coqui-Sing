        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="bg-gradient-to-r from-primary-500 to-secondary-500 rounded-lg p-4 text-white">
              <h3 className="font-display font-semibold text-sm mb-2">Upgrade to Premium</h3>
              <p className="text-xs opacity-90 mb-3">
                Unlock advanced exercises and AI-powered feedback
              </p>
              <button className="w-full bg-white text-primary-500 px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-100 transition-colors">
                Learn More
              </button>
            </div>
          </div>
